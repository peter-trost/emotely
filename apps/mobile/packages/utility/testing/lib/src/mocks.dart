...
/// only seam through which server behavior is faked; the PostHog SDK is a
...
///
/// The annotation sits on the export of the generated library, which is
/// where mockito looks for it (top-level elements, imports and exports).
@GenerateNiceMocks([MockSpec<http.Client>(), MockSpec<Posthog>()])
export 'package:testing/src/mocks.mocks.dart';
