  ...
  Component build(BuildContext context) => const main_(classes: 'page prose', [
    ...
    p([
      .text(
        ...
        'hang together. One further marker is attached to the account '
        'identifier: a yes-or-no flag saying whether the account is one of '
        'our own test or review accounts, worked out from the address’s '
        'domain so that our own use does not skew the numbers — the flag is '
        'sent, never the address it was worked out from. Both identifiers '
        'are pseudonymous, not anonymous. Signing out or '
